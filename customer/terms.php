<?php
// /customer/terms.php - Customer Terms Page (uses same CMS content as public)
...
if ($isPreview) {
    ...
    $content = getCMSContent('terms'); // Gets published, same as public
}
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="/customer/products.php?type=Wardrobe">Bedroom</a></li>
