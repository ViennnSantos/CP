...
<head>
  ...
  <style>
    * {
    ...
    .notice-box .material-symbols-rounded {
      font-size: 24px;
      color: #b45309;
      flex-shrink: 0;
    }
      ...
      <div id="savedAddressesContainer" style="margin-bottom: 24px; display: none;">
        <div class="form-group">
          <label style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <button type="button" class="btn-link" onclick="window.location.href='/RADS-TOOLING/customer/profile.php#address'" style="font-size: 14px; color: #2f5b88; background: none; border: none; cursor: pointer; text-decoration: underline;">
              + Add New Address
            </button>
          </label>
